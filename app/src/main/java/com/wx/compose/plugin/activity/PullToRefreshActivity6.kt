...
class PullToRefreshActivity6 : ComponentActivity() {
...
fun PullToRefreshSample6(onClick: () -> Unit) {
...
//            ) {
            Text(
                modifier = Modifier
                    .fillMaxSize()
                    .background(Color.Red)
                    .verticalScroll(rememberScrollState()),// 一定要加这句，
                text = "AAAAAAAAAAAA", color = Color.Green, textAlign = TextAlign.Center
            )
//            }
        }
    }
